<?php
session_start();
$recipe_result = $_SESSION['search_results'] ?? [];
$searchTerm = $_SESSION['search_term'] ?? '';
$recipe_all = $_SESSION['recipe_all'];
...
<body>
  ...
  <div class="container">
    ...
    <div class="search-result-content">
      <?php if ($recipe_result): ?>
        <div class="card-container">
          <?php foreach ($recipe_result as $receta): ?>
            <div class="card">
      ...
      <?php elseif ($recipe_all): ?>
        <div class="content-recipe-all">
          <div class="card-container">
            <?php foreach ($recipe_all as $receta): ?>
              <div class="card">
                <div class="content-img">
                  <img src="/uploads/<?php echo htmlspecialchars($receta['imagen']); ?>" alt="<?php echo htmlspecialchars($receta['nombre']); ?>" class="card-image">
                </div>
